...
let bundlePromise;
const previewBundle=()=>bundlePromise??=fetch('./previews/0.6.0/compiled/bundle.json?v=preview-release-23').then(r=>{if(!r.ok)throw Error('Build receipt unavailable');return r.json();});
