...
fn resolve_wheel_motion(position_input: vec2<f32>, velocity_input: vec2<f32>,
  particle_radius: f32) -> ContactResult {
...
fn advect(@builtin(global_invocation_id) invocation: vec3<u32>) {
  ...
  let wheel_contact = resolve_wheel_motion(contact.position, contact.velocity, radius);
...
fn update_diffuse_and_render(@builtin(global_invocation_id) invocation: vec3<u32>) {
  ...
  let wheel_contact = resolve_wheel_motion(contact.position, contact.velocity, marker.radius);
