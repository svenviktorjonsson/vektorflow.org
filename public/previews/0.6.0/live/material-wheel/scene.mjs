...
const renderFrame = (timestamp) => {
  try {
    ...
    if (playing && elapsed > 0) {
      ...
      if (timing.steps > 0) active.runtime.stepMany(encoder, timing.steps, active.runtime.policy.timeStep);
    }
...
try {
  ...
  window.__materialWheel = { waterRuntime, sandRuntime, waterEmbedding, sandEmbedding };
