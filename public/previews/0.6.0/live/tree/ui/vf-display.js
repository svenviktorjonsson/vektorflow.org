...
(function (global) {
  ...
  function buildSingleMesh(spec, camera, lights) {
    ...
    var authoredSurfaceSystem = spec.surface_system || mesh.surface_system || null;
    out.surface_system = authoredSurfaceSystem && typeof authoredSurfaceSystem === "object"
      ? Object.assign({}, authoredSurfaceSystem)
      : null;
    ...
    out.water_dielectric = spec.water_dielectric || mesh.water_dielectric || null;
    out.water_optical_scene = spec.water_optical_scene || mesh.water_optical_scene || null;
    out.water_transmission_bound = spec.water_transmission_bound || mesh.water_transmission_bound || null;
    out.water_submersion_optics = spec.water_submersion_optics || mesh.water_submersion_optics || null;
    out.water_screen_refraction = spec.water_screen_refraction || mesh.water_screen_refraction || null;
    out.water_planar_reflection = spec.water_planar_reflection || mesh.water_planar_reflection || null;
    out.water_whitewater_field = spec.water_whitewater_field || mesh.water_whitewater_field || null;
    out.splash_role = spec.splash_role || mesh.splash_role || null;
    out.exclude_from_surface_pass = spec.exclude_from_surface_pass === true
      || mesh.exclude_from_surface_pass === true;
    out.diffuse_whitewater = spec.diffuse_whitewater === true
      || mesh.diffuse_whitewater === true;
    out.multiple_scattering = spec.multiple_scattering === true
      || mesh.multiple_scattering === true;
    out.air_fraction = Number.isFinite(Number(spec.air_fraction))
      ? Number(spec.air_fraction) : Number(mesh.air_fraction || 0);
    out.sand_granular_material = spec.sand_granular_material || mesh.sand_granular_material || null;
    out.water_caustic_receiver = spec.water_caustic_receiver || mesh.water_caustic_receiver || null;
