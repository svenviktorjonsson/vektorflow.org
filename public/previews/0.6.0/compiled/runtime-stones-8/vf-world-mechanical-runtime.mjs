...
export function prepareMechanicalInitialState(world,arenas,asset){
  ...
  if(kind==='rigid'){
    ...
    const nodeArena=arenas.find(a=>a.layer.id===world.nodes_layer_id);initial.nodeCount=nodeArena.layer.count;initial.nodes=new Float32Array(initial.nodeCount*16);initial.geometry=new Float32Array(initial.nodeCount*16);
