...
const runtime_directory=id==='wheel'?'runtime-wheel-26':id==='stones'?'runtime-stones-12':'runtime-tree-11',directory=id==='wheel'?'wheel-performance-26':id==='stones'?'stones-mixed-12':'tree-air-11';
