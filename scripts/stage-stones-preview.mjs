...
const runtime_directory=id==='wheel'?'runtime-wheel-16':id==='stones'?'runtime-stones-8':'runtime-tree-10',directory=id==='wheel'?'wheel-performance-16':id==='stones'?'stones-granite-8':'tree-air-10';
