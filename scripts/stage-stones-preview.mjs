...
const runtime_directory=id==='wheel'?'runtime-wheel-13':id==='stones'?'runtime-stones-8':'runtime-tree-9',directory=id==='wheel'?'wheel-startup-13':id==='stones'?'stones-granite-8':'tree-wind-9';
