...
const runtime_directory=id==='wheel'?'runtime-wheel-23':id==='stones'?'runtime-stones-12':'runtime-tree-11',directory=id==='wheel'?'wheel-performance-23':id==='stones'?'stones-mixed-12':'tree-air-11';
