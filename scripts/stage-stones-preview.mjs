...
const runtime_directory=id==='wheel'?'runtime-wheel-29':id==='stones'?'runtime-stones-15':'runtime-tree-11',directory=id==='wheel'?'wheel-water-only-29':id==='stones'?'stones-mixed-15':'tree-air-11';
