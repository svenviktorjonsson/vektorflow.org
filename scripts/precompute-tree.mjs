...
const target=new URL('../public/previews/0.6.0/live/tree/assets/',import.meta.url);await mkdir(target,{recursive:true});await writeFile(new URL(asset.replace('.bin.gz','-feedback-8.bin.gz'),target),gzipSync(output,{level:9}));
